					...
					<form action="<c:url value='/seach'/>" id="formSubmit" method="get">
						<div class="form-row" >
							...
							<div class="form-group col-md-2">
								...
								<button type="submit" class="" style="background: black;border-color: white;height: 50px;color: white;box-shadow: 3px 3px 2px #808080">Tìm Kiếm</button>
							</div>
						</div>
							</form>
...
<div class="product-item bg-light">
		...
		<div class="thumb-content">
			<!-- <div class="price">$200</div> -->
			 ...
			 <div class="product-f-image">
				<img class="card-img-top img-fluid" src="<c:url value='/resources/images/${item.afterimage}'/>" style="height: 250px;box-shadow: 9px 3px 9px black" alt="Card image cap">
				  <div class="product-hover" >
                                        <a  style="background: pink;border-radius: 100px	;box-shadow: 3px 3px 2px pink" onclick="PushIncart('${item.id}','${item.afterimage}','${item.gia}','${item.title}')" href="#!" id="carta"  class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Thêm vào giỏ </a>
                                        <a style="background: pink;border-radius: 100px;box-shadow: 3px 3px 2px pink	" href="ctsp?cate=${cate }&id=${item.id}" class="view-details-link"><i class="fa fa-link"></i> Xem chi tiết</a>
                                    </div>
                                    </div>
	...
	<form action="<c:url value='/trang-chu/sp'/>" id="formSubmit1" method="get">						
<ul class="pagination" id="pagination" style="height: 30px;position: absolute;left: 600px;top: 1580px"></ul>	
