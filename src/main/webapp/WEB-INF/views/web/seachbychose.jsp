			 ...
			 <div class="product-f-image">
				<img class="card-img-top img-fluid" src="<c:url value='/resources/images/${item.afterimage}'/>" style="height: 250px" alt="Card image cap">
				  <div class="product-hover">
                                        ...
                                        <a style="background: pink;border-radius: 100px" href="trang-chu/ctsp?cate=${item.categoryId }&id=${item.id}" class="view-details-link"><i class="fa fa-link"></i> Xem chi tiết</a>
                                    </div>
                                    </div>
			
		</div>
		<div class="card-body">
		    <h4 class="card-title"><a href="single.html" style="color: #009999">${item.title}</a></h4>
