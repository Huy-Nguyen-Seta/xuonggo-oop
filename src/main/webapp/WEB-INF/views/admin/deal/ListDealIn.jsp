...
color:#ffffff
		...
		<header class="py-5" >
                ...
                <div class="p-4 p-lg-5  rounded-3 text-center"  >
                        ...
                        <h1 class="display-5 fw-bold" style="">Danh sách hoá đơn!</h1>
...
function loadDeal(){
	...
	for(var i=0;i<list.length;i++){
	    ...
	    if(list[i].nhacc.fullName.toLowerCase().indexOf(tukhoa)>-1)
	    {
	        ...
	        '                    <div class="card h-100" style="border-color: #ffffff" >\n'+
	        '                     <div class="card-footer" style="border-top-left-radius  : 90px;height: 40px;border-top-right-radius: 90px;background: 	#1E90FF"></div>\n'+
	        '                        <div class="card-body" style="background: #00BFFF;border-bottom-left-radius: 60px;border-bottom-right-radius: 60px" >\n'+
	        '                            <h2 style="position: relative;left: 27%;color:#FFFF00" class="card-title">Mã  Đơn '+list[i].id+'</h2>\n'+
	        '                            <p class="card-text">➤Khách Hàng : '+list[i].nhacc.fullName+' </p>\n'+
	        '                            <hr style=" border: 1px solid black;">\n'+
	        '                             <p " class="card-text">➤Giá Trị Đơn Hàng : '+list[i].giahoadon+'.000 VNĐ</p>\n'+
	        '                            <hr style=" border: 1px solid black;">\n'+
	        '                             <p class="card-text">➤Ngày Lập Hoá Đơn: '+list[i].createdDate+'</p>\n'+
	        '                            <hr style=" border: 1px solid black;">\n'+
	        '                            <a  class="btn btn-primary btn-lg" style="position: relative;left: 27%;color: pink;background-color: pink" href="./showdealnhap?id='+list[i].id+'">Xem chi tiết</a>\n'+
	        '                        </div>\n'+
	        '                       \n'+
	        '                    </div>\n'+
	        '                </div>';
